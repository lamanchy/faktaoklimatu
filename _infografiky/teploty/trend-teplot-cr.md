...
caption:    "Průměrná roční teplota v České republice narostla za posledních 58 let o 2 °C. Trendy v oteplování jednotlivých měsíců jsou různé. Největší nárůst teplot je v lednu, červenci a srpnu &ndash; tyto měsíce se od roku 1961 oteplily o více než 2,6 °C."
...
* Trendy nárůstu teploty jsou statisticky významné na hladině významnosti α = 0.05 v měsících leden, duben–srpen, listopad a prosinec i v celoročním průměru. V únoru, březnu, září a říjnu není nárůst tak velký, aby byl vzhledem k velkému meziročnímu kolísání teplot statisticky významný, i v těchto měsících se však průměrná teplota postupně zvyšuje. 
